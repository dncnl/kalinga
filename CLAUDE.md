...
## Tech stack
- Flutter (`apps/mobile`) — Android, iOS, Web, Windows
- Node/Express (`apps/api`) — backend, Firebase Admin SDK
- Firebase — Auth, Firestore, Storage (project: `kalinga-bc97f`)
- Firestore schema package: `packages/kalinga_firestore_package`
