...
// itself now lives in ragSources (Firestore) — add/edit documents there,
// not here; ingest.js reads from Firestore, not from this file. Each entry
// here is a real, cited public source (Taiwan health authority, WHO, or
// peer-reviewed research) — see individual files for URLs and retrieval
// dates.
module.exports = [
