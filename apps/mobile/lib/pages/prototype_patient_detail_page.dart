...
class PrototypePatientDetailPage extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              _buildMenuRows(context, patient),
              const SizedBox(height: 20),
              _buildEditButton(context),
              const SizedBox(height: 12),
              _buildPreviewLink(context),
              const SizedBox(height: 24),
            ],
          ),
        ),
  ...
  Widget _buildMenuRows(BuildContext context, _PatientData patient) {
    final rows = [
      _MenuRow(
      ...
      _MenuRow(
        ...
        onTap: () => context.push('/patients/$patientId/schedules'),
      ),
      _MenuRow(
        ...
        onTap: () => context.push('/viewer/$patientId'),
      ),
      _MenuRow(
  ...
  Widget _buildPreviewLink(BuildContext context) {
    return Center(
